...
|---|---:|---:|---:|
| Базавая гульня | 57 469 | 69 683 | **82.5 %** |
| Hearts of Stone | 0 | 6 606 | 0 % |
| Blood and Wine | 0 | 17 155 | 0 % |
| Іншыя DLC | 0 | 986 | 0 % |
| **Усяго** | **57 469** | **94 430** | **60.9 %** |
...
data/            паралельныя дадзеныя перакладу (en / ru / pl / bel) па файлах гульні
  content0.json  …  content12.json   базавая гульня і патчы
  dlc/           dlcN / ep1 / bob    дадаткі (з'явяцца па меры перакладу)
